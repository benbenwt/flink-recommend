...
public class TopNHotItems extends KeyedProcessFunction<Tuple, TopProductEntity, List<TopProductEntity>>  {
    ...
    @Override
    public void processElement(TopProductEntity topProductEntity, Context context, Collector<List<TopProductEntity>> collector) throws Exception {
    ...
    @Override
    public void onTimer(long timestamp, OnTimerContext ctx, Collector<List<TopProductEntity>> out) throws Exception {
